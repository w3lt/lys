...
| An SDK client is captured by functions supplied to the LLM service                    | Hiding the concrete client behind operations does not remove the captured dependency's lifetime or cleanup obligation.                                                       |
