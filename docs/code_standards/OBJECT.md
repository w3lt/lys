...
Schema-derived payloads and contract metadata follow `TYPE-009`; this rule MUST NOT require duplicate handwritten shapes or runtime-schema wrappers for metadata that does not need runtime validation.
