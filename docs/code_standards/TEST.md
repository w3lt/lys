...
| Service tests hold one operation with explicit start and release promises                                                               | The harness can exercise selected queue and shutdown interleavings. Its existence does not prove every schedule or failure-safe barrier cleanup.                            |
